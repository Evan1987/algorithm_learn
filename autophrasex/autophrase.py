...
from .extractors import FeatureExtractorWrapper
...
class AutoPhrase:
    ...
    def _organize_phrase_pools(self, quality_phrases, frequent_phrases):
        pos_pool, neg_pool = [], []
