...
from ragen.env.sokoban import Env
from ragen.evaluators.trajectory_evaluator import TrajectoryEvaluator
from typing import *


class BasePolicy:
    def select_action(self, observation, env: Optional[Env] = None):
        raise NotImplementedError("This method should be overridden.")

    def select_action_multienv(self, observations: List[str], envs: List[Env] = None):
        """
...
class LLMPolicy(BasePolicy):
    ...
    def select_action(self, observation: str, env: Optional[Env] = None) -> int:
